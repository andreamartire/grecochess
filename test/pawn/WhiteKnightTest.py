...
class WhiteKnightTest(unittest.TestCase):
    ...
    def testWhiteKnightMoveUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
        ...
        move = Generator.getMoveByIndexes(board, Constants.WHITE, 27, 44)
    ...
    def testWhiteKnightTakeBlackPawnUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
        ...
        assert len(board.blackPawnsIndexes) == 1
        assert Utils.getCellBitArrayById(27) in board.whiteKnightIndexes
        assert Utils.getCellBitArrayById(44) in board.blackPawnsIndexes
    ...
    def testWhiteKnightTakeBlackKnightUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
    ...
    def testWhiteKnightTakeBlackBitshopUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
        ...
        assert len(board.blackBitshopsIndexes) == 1
        assert Utils.getCellBitArrayById(27) in board.whiteKnightIndexes
        assert Utils.getCellBitArrayById(44) in board.blackBitshopsIndexes
    ...
    def testWhiteKnightTakeBlackRookUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
    ...
    def testWhiteKnightTakeBlackQueenUpRight(self):
        board = QuadBitBoard.QuadBitBoard()
        board.clean()
